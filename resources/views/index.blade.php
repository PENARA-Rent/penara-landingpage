...
<html lang="en-US">
   <head>
      ...
      <!--Bootstrap css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/bootstrap.css')}}">
      <!--Font Awesome css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/font-awesome.min.css')}}">
      <!--Magnific css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/magnific-popup.css')}}">
      <!--Owl-Carousel css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/owl.carousel.min.css')}}">
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/owl.theme.default.min.css')}}">
      <!--Animate css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/animate.min.css')}}">
      <!--Datepicker css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/jquery.datepicker.css')}}">
      <!--Nice Select css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/nice-select.css')}}">
      <!-- Lightgallery css -->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/lightgallery.min.css')}}">
      <!--ClockPicker css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/jquery-clockpicker.min.css')}}">
      <!--Slicknav css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/slicknav.min.css')}}">
      <!--Site Main Style css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/style.css')}}">
      <!--Responsive css-->
      <link rel="stylesheet" href="{{asset ('gauto/assets/css/responsive.css')}}">
   </head>
   <body>
                              ...
                              <ul class="product_list">
                                 <li>
                                    <div class="cart-btn-product">
                                       ...
                                       <div class="cart-btn-pro-img">
                                          <a href="#">
                                          <img src="{{asset ('gauto/assets/img/cart-1.png')}}" alt="product" />
                                          </a>
                                       </div>
                                 ...
                                 <li>
                                    <div class="cart-btn-product">
                                       ...
                                       <div class="cart-btn-pro-img">
                                          <a href="#">
                                          <img src="{{asset ('gauto/assets/img/cart-2.jpg')}}" alt="product" />
                                          </a>
                                       </div>
                                       <div class="cart-btn-pro-cont">
                                          <h4><a href="#">CAR SPOILERS</a></h4>
                  ...
                  <div class="service-slider owl-carousel">
                     <div class="single-service">
                        ...
                        <div class="service-icon">
                           <img src="{{asset ('gauto/assets/img/city-transport.png')}}" alt="city trasport" />
                        </div>
                     ...
                     <div class="single-service">
                        ...
                        <div class="service-icon">
                           <img src="{{asset ('gauto/assets/img/airport-transport.png')}}" alt="airport trasport" />
                        </div>
                        <div class="service-text">
                           <a href="#">
                     ...
                     <div class="single-service">
                        ...
                        <div class="service-icon">
                           <img src="{{asset ('gauto/assets/img/hospital-transport.png')}}" alt="hospital trasport" />
                        </div>
                        <div class="service-text">
                           <a href="#">
                     ...
                     <div class="single-service">
                        ...
                        <div class="service-icon">
                           <img src="{{asset ('gauto/assets/img/wedding-ceremony.png')}}" alt="wedding trasport" />
                        </div>
                        <div class="service-text">
                           <a href="#">
                     ...
                     <div class="single-service">
                        ...
                        <div class="service-icon">
                           <img src="{{asset ('gauto/assets/img/hotel-transport.png')}}" alt="wedding trasport" />
                        </div>
                        <div class="service-text">
                           <a href="#">
                     ...
                     <div class="single-service">
                        ...
                        <div class="service-icon">
                           <img src="{{asset ('gauto/assets/img/luggege-transport.png')}}" alt="wedding trasport" />
                        </div>
                        <div class="service-text">
                           <a href="#">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="promo-box-left">
                     <img src="{{asset ('gauto/assets/img/toyota-offer-2.png')}}" alt="promo car" />
                  </div>
               </div>
               <div class="col-md-6">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-3 col-sm-6">
                  <div class="single-driver">
                     <div class="driver-image">
                        <img src="{{asset ('gauto/assets/img/driver-1.jpg')}}" alt="driver 1" />
                        <div class="hover">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-driver">
                     <div class="driver-image">
                        <img src="{{asset ('gauto/assets/img/driver-2.jpg')}}" alt="driver 1" />
                        <div class="hover">
                           <ul class="social-icon">
                              <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                              <li><a href="#"><i class="fa fa-twitter"></i></a></li>
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-driver">
                     <div class="driver-image">
                        <img src="{{asset ('gauto/assets/img/driver-4.jpg')}}" alt="driver 1" />
                        <div class="hover">
                           <ul class="social-icon">
                              <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                              <li><a href="#"><i class="fa fa-twitter"></i></a></li>
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="single-driver">
                     <div class="driver-image">
                        <img src="{{asset ('gauto/assets/img/driver-3.jpg')}}" alt="driver 1" />
                        <div class="hover">
                           <ul class="social-icon">
                              <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                              <li><a href="#"><i class="fa fa-twitter"></i></a></li>
